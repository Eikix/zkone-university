...
contract Ballot {
    ...
    /**
    * @dev Ensures caller is chairperson
    */
    ...
    /** 
     * @dev Give a specific list of voters the right to vote on this ballot. May only be called by 'chairperson'.
     * @param voterList addresses of voters
     */
